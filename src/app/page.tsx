  ...
  return (
    <>
      ...
      <main className="container mx-auto p-6">
        {/* Main Card with Balance */}
        <Card className="mb-6 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <CardContent className="pt-6">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-sm opacity-80">Card Owner</p>
                <h3 className="font-semibold">Ahmad Arianto</h3>
              </div>
              <Badge variant="outline" className="border-white text-white">
                + 2.3
              </Badge>
            </div>
            <h2 className="text-4xl font-bold mb-4">$4300.00</h2>
            <p className="text-sm opacity-80">**** **** 4223</p>
          </CardContent>
        </Card>
